...
const getSignByDate = ({ day, month }, language) => {
	...
	const signsData = Object.values(require('zodiac-signs/data/zodiac'));
	let signsLocale;
	try {
		signsLocale = Object.values(require(`./locales/${language}/zodiac.json`));
	} catch {
		signsLocale = Object.values(require('zodiac-signs/locales/en/zodiac'));
	}
...
const getSymbols = () => {
	const signsData = require('zodiac-signs/data/zodiac');
...
const getElements = (language) => {
	...
	try {
		...
		elementsData = Object.values(require('zodiac-signs/locales/en/elements'));
	}
...
const getElement = (sign, language) => {
	...
	try {
		...
		elementsData = require('zodiac-signs/locales/en/elements');
	}
